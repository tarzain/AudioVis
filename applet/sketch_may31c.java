...
//  max=0;
  ...
  if(showStars){
    for(int i=fft.specSize(); i>0; i-=10){
        rect(i+1,(height-fft.getBand(i)*4)-height/2,0.5f,0.5f);
        fill(255);
    }  
    for(int i=0; i<fft.specSize(); i+=10){
        rect((width-i),(height-fft.getBand(i)*4)-height/2,0.5f,0.5f);
        fill(255);
    }
  }  
...
//   System.out.println(x+" "+y+" "+z); 
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#D4D0C8", "sketch_may31c" });
  }
}
